...
class Configuration(dict):
    ...
    Attributes:
        ...
        otel_service_name (str): The name of the service or application that is generating telemetry data. Default: "sdbx".
    ...
    def __init__(self, **kwargs):
        ...
        self.distributed_queue_name: str = "sdbx"
        ...
        self.otel_service_name: str = "sdbx"
