...
export class UserSelectionScreen {
	async show(users, user) {
		...
		const userSelection = document.getElementById("sdbx-user-selection");
		...
		return new Promise((resolve) => {
			...
			const error = userSelection.getElementsByClassName("sdbx-user-error")[0];
			const button = userSelection.getElementsByClassName("sdbx-user-button-next")[0];
