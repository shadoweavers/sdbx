...
const html = fs.readFileSync(path.resolve("../sdbx/web/index.html"))
...
export async function start(config = {}) {
	...
	mockApi(config);
	const { app } = require("../../sdbx/web/scripts/app");
	config.preSetup?.(app);
	await app.setup();
 ...
 * @returns { Record<string, import("../../sdbx/web/types/sdbx").ComfyObjectInfo> }
 */
